...
namespace GasmaskGraves
{
    ...
    {
        private const string MenuName = "GasmaskGraves";
        ...
        static Config()
        {
            ...
            Menu.AddGroupLabel("Welcome to GasmaskGraves");
            Menu.AddLabel("Don't forget your gasmask.");
            Menu.AddLabel("Make sure it's on tight.");
            Menu.AddLabel("You're gonna need it.");
        ...
        public static class Modes
        {
            ...
            {
                // Initialize the menu
                Menu = Config.Menu.AddSubMenu("Attach Gasmask");
            ...
            public static class Combo
            {
                ...
                static Combo()
                {
                    ...
                    _useR = Menu.Add("comboUseR", new CheckBox("Use R (Automatic use if in Range)", false)); // Default false
                }
